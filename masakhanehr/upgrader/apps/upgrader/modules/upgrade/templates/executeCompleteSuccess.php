...
<div>
    ...
    <ul>
        <li>
            If notes were displayed under <strong>Version Info</strong>, make sure you understand them thoroughly. You can find the notes at <strong>upgrader/log/notes.log</strong> in your MasakhaneHRM root folder.
        </li>
        <li>
