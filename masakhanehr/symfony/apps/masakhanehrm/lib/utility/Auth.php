...
/**
 * MasakhaneHRM Authentication & Authorization library. Taken from insurance branch.
 */
class Auth {

    /** Original MasakhaneHRM modules. We may need to change this once MasakhaneHRM is modularized */
     ...
     * 
     * Note: 
     * Due to the current MasakhaneHRM authorization system, actions (edit/view etc.) are
    ...
    /**
     * Function used to get user group rights. Should be later moved to the Rights class in MasakhaneHRM (Rights.php)
     */
